...
class Servicio extends CoreController {
	...
	public function add(){
		...
		$this->template['view'] .= $this->load->view("admin/nomencladores/servicio/add", array("id"=>"servicio","subtitle"=>"Servicios"), true);
        $this->loadAdmin();
	...
	public function edit(){
		...
		$this->template['view'] .= $this->load->view("admin/nomencladores/servicio/edit", array("id"=>"servicio","subtitle"=>"Servicios","result"=>$result), true);
        $this->loadAdmin();
	}
