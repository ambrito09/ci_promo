...
class Madmin extends CoreModel {
	...
	public function estadisticas(){
		...
		$visitas = $this->db->get_where('contador',array('id_publicidad' => 0))->first_row()->cantidad; 
		$this->db->select("count(id) as cantidad");
		...
		$this->db->select("count(id) as cantidad");
		$publicidad = $this->db->get_where('publicidad')->first_row()->cantidad; 
		return array("visitas"=>$visitas,"usuarios"=>$usuarios,"publicidad"=>$publicidad,"visitas_publicidad"=>$visitas_publicidad);
	}
